...
class GetSmsCodeAction
{
    ...
    public function run(GetSmsDto $smsDto)
    {
        ...
        /**
         * @var SmsCodeCache $cache
         */
        $cache = $this->redisUtils->getCacheQuery(SmsCodeCache::class)->getObject($smsDto->phone);
